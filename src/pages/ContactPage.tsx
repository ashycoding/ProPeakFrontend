        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-base sm:text-lg text-[#527A68] leading-relaxed">
              Whether you have a concrete project requirement, need technical
              consulting, or want to explore talent collaborations, we are here
              to help.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-16">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="p-8 rounded-3xl bg-white border border-[#D1FAE5] shadow-xs space-y-4">
                <h3 className="text-xl font-bold text-[#052E20]">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="p-8 sm:p-10 rounded-3xl bg-[#0A4F3A] text-white shadow-xl space-y-6 h-full flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <h3 className="text-3xl font-gerbil font-light  tracking-tight">
                    Ready to Start a Specific Project?
                  </h3>

                  <p className="text-sm sm:text-base text-white/80 leading-relaxed">
                    Submit your requirement via our dedicated project intake
                    flow. We collect your scope, target timelines, and budget
                    expectations to provide an accurate proposal.
                  </p>
