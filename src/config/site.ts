export interface ServiceItem {
  ...
  fullDesc: string
  iconName: string
  category: 'Development' | 'AI & Data' | 'Creative & Media' | 'Mentorship & Advisory'
  skills: string[]
  deliverables: string[]
...
export const siteConfig = {
  ...
  googleFormUrl: import.meta.env.VITE_GOOGLE_PROJECT_FORM_URL || 'https://forms.gle/oTRxffbuEJQiLFee6',
  analyticsId: import.meta.env.VITE_ANALYTICS_ID || '',
  socialLinks: {
    linkedin: import.meta.env.VITE_LINKEDIN_URL || 'https://www.linkedin.com/company/propeak-in/',
...
export const servicesData: ServiceItem[] = [
  {
    ...
    iconName: 'Globe',
    shortDesc: 'Modern, high-speed websites, responsive web apps, landing pages, and interactive UI systems.',
    fullDesc:
    ...
    skills: ['React', 'Next.js', 'TypeScript', 'TailwindCSS', 'REST APIs', 'Framer Motion'],
    deliverables: [
  ...
  },
  {
    ...
    category: 'AI & Data',
    iconName: 'Cpu',
    shortDesc: 'Intelligent AI models, custom LLM integrations, retrieval pipelines (RAG), and smart automations.',
    fullDesc:
    ...
    skills: ['Python', 'PyTorch', 'TensorFlow', 'OpenAI / Anthropic APIs', 'LangChain', 'FastAPI'],
    deliverables: [
  ...
  },
  {
    ...
    category: 'Development',
    iconName: 'Smartphone',
    shortDesc: 'Native-feel cross-platform mobile apps for iOS and Android built with React Native and Flutter.',
    fullDesc:
    ...
    skills: ['React Native', 'Expo', 'Flutter', 'Mobile UI/UX', 'Async Storage', 'Push Notifications'],
    deliverables: [
  ...
  },
  {
    ...
    category: 'AI & Data',
    iconName: 'BarChart3',
    shortDesc: 'Interactive business intelligence dashboards, automated ETL pipelines, and insightful metrics.',
    fullDesc:
    ...
    skills: ['Python', 'SQL', 'Pandas / NumPy', 'Tableau / PowerBI', 'ETL Pipelines', 'Plotly'],
    deliverables: [
  ...
  },
  {
    ...
    iconName: 'Video',
    shortDesc: 'High-retention product launch reels, YouTube post-production, motion graphics, and social promo.',
    fullDesc:
    ...
    skills: ['Premiere Pro', 'After Effects', 'DaVinci Resolve', 'Sound Design', 'Motion Graphics', 'Color Grading'],
    deliverables: [
  ...
  },
  {
    ...
    category: 'Creative & Media',
    iconName: 'Palette',
    shortDesc: 'Brand identity systems, vector assets, marketing collateral, pitch decks, and Figma UI design.',
    fullDesc:
    ...
    skills: ['Figma', 'Adobe Illustrator', 'Photoshop', 'Brand Systems', 'Typography', 'UI Wireframing'],
    deliverables: [
  ...
  },
  {
    ...
    category: 'Creative & Media',
    iconName: 'FileText',
    shortDesc: 'Professional content for brands, websites, blogs, technical products, documentation, and SEO.',
    fullDesc:
    ...
    skills: ['SEO Copywriting', 'Technical Documentation', 'Blog Strategy', 'Website Copy', 'Case Studies', 'Editing'],
    deliverables: [
  ...
  },
  {
    ...
    shortDesc: 'Engineering project guidance, architectural reviews, prototype builds, and source code walkthroughs.',
    fullDesc:
    ...
    skills: ['Full-Stack Architectures', 'ML / AI Prototypes', 'System Design', 'Code Walkthroughs', 'Documentation'],
    deliverables: [
  ...
  },
  {
    ...
    category: 'Mentorship & Advisory',
    iconName: 'Compass',
    shortDesc: 'Architecture audits, database optimization, technology roadmap planning, and code quality reviews.',
    fullDesc:
    ...
    skills: ['Architecture Audits', 'Database Optimization', 'Cloud Infrastructure', 'Security Reviews', 'DevOps'],
    deliverables: [
...
export const showcaseData: ProjectShowcaseItem[] = [
  {
    ...
    category: 'Web',
    scope: 'Responsive marketing website with animated component library, interactive pricing calculator, and high Core Web Vitals score.',
    technologies: ['Next.js', 'React', 'TailwindCSS', 'Framer Motion'],
    sampleOutcome: 'Sample Outcome: 98+ Lighthouse performance score, 0.4s initial load time, and clean modular component architecture.',
    featured: true,
  },
  {
    id: 'p2',
    ...
    category: 'AI/ML',
    scope: 'Custom retrieval-augmented generation (RAG) pipeline enabling semantic search and conversational queries across technical PDF libraries.',
    technologies: ['Python', 'FastAPI', 'LangChain', 'OpenAI Embeddings', 'ChromaDB'],
    sampleOutcome: 'Sample Outcome: Sub-second search retrieval across 1,000+ pages with cited source passages.',
    featured: true,
  },
  {
    id: 'p3',
    ...
    category: 'Data',
    scope: 'Automated data ingestion pipeline aggregating transactional data into an interactive KPI overview with retention heatmaps.',
    technologies: ['Python', 'PostgreSQL', 'Pandas', 'Plotly / Dash'],
    sampleOutcome: 'Sample Outcome: Automated weekly reporting eliminating 10+ hours of manual data assembly.',
    featured: true,
  },
  {
    id: 'p4',
    ...
    category: 'Video',
    scope: '60-second high-energy product launch video featuring custom 3D device mockups, kinetic typography, and synchronized sound design.',
    technologies: ['After Effects', 'Premiere Pro', 'DaVinci Resolve'],
    sampleOutcome: 'Sample Outcome: High-retention social promotional video ready for multi-channel ad campaigns.',
    featured: true,
  },
  {
    id: 'p5',
    ...
    category: 'Design',
    scope: 'Complete brand guidelines, design tokens, responsive typography scale, and 40+ atomic Figma UI components.',
    technologies: ['Figma', 'Adobe Illustrator', 'Design Systems'],
    sampleOutcome: 'Sample Outcome: Ready-to-implement design system reducing frontend prototyping time by 40%.',
    featured: true,
  },
  {
    id: 'p6',
    ...
    category: 'Content',
    scope: 'Comprehensive developer documentation suite covering authentication flows, endpoint specifications, and copy-paste code snippets.',
    technologies: ['Markdown', 'Technical Writing', 'API Specs', 'SEO'],
    sampleOutcome: 'Sample Outcome: Crystal-clear developer onboarding guide with complete code examples.',
    featured: true,
  },
  {
    id: 'p7',
    ...
    category: 'Web',
    scope: 'React Native mobile application featuring live map tracking, order status updates, and push notifications.',
    technologies: ['React Native', 'Expo', 'TypeScript', 'Tailwind'],
    sampleOutcome: 'Sample Outcome: Unified codebase deployed to both iOS TestFlight and Android staging builds.',
  },
  {
    id: 'p8',
    title: 'SEO Content Cluster for SaaS Product',
    category: 'Content',
    scope: 'Cluster of 6 long-form SEO articles covering core product use cases, keyword research, and informative diagrams.',
    technologies: ['SEO Strategy', 'Copywriting', 'Content Architecture'],
    sampleOutcome: 'Sample Outcome: Comprehensive topical authority cluster targeting high-intent search queries.',
  },
]
...
export const techStackData = [
  ...
  { name: 'Next.js', category: 'Fullstack', desc: 'Server-Side & Hybrid React' },
