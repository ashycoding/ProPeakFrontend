...
export const ServicesTicker: React.FC = () => {
  const tickerItems = [
    ...
    'Mobile Apps',
    'Graphic Design',
    'Final Year Projects & Mentorship',
  ...
  return (
    <div className="bg-[#0A4F3A] py-4 sm:py-5 border-y border-[#0D7A58]/50 overflow-hidden relative select-none">
      {/* Edge gradient fade masks for smooth transition */}
      <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-28 bg-gradient-to-r from-[#0A4F3A] to-transparent z-10 pointer-events-none" />
      ...
      <div className="flex w-max animate-infinite-scroll hover:[animation-play-state:paused]">
        {repeatedItems.map((item, index) => (
          <div key={index} className="flex items-center mx-4 sm:mx-6 group cursor-default">
