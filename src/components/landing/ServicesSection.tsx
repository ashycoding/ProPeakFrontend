      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-[#527A68] leading-relaxed">
            From modern web applications and AI workflows to high-retention video editing and professional SEO content. Every service is supervised by technical leads to guarantee quality.
          </p>
        </div>
        ...
        <div className="mt-14 p-6 sm:p-8 rounded-2xl bg-white border border-[#D1FAE5] shadow-xs text-center flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-left">
            <h4 className="text-lg font-bold text-[#052E20]">Looking for a customized digital solution?</h4>
            <p className="text-sm text-[#527A68]">We tailor engineering teams and scopes specifically for your startup or business.</p>
          </div>
          <Link
            to="/start-project"
            className="px-6 py-3 text-sm font-bold rounded-xl bg-[#0A4F3A] hover:bg-[#0D7A58] text-white shadow-sm transition-all whitespace-nowrap active:scale-95"
          >
