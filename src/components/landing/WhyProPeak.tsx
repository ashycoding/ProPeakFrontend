      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-[#527A68] leading-relaxed">
            We bridge the gap between high-caliber student developers and
            ambitious businesses. Every project is planned, reviewed, and
            overseen by technical leads.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-[#D1FAE5]/60 flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-[#527A68]">
                    Core Quality Guarantee
                  </span>
                </div>
              </motion.div>
            );
