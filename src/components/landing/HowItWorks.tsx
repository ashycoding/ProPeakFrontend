...
export const HowItWorks: React.FC = () => {
  return (
    <section
      id="how-it-works"
      className="py-20 lg:py-28 bg-white border-y border-[#D1FAE5] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className=" text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-[#527A68] leading-relaxed">
            From initial project submission to final milestone delivery, our
            structured engineering workflow keeps projects transparent, timely,
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block mt-8 text-center">
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-[#F0FDF8] border border-[#D1FAE5] text-xs font-semibold text-[#0D7A58]">
              ...
              />
              <span>
                Full milestone tracking, structured reviews & quality gates at
                every stage
              </span>
            </div>
          </div>
